...
exports.FakeStatusImgForwarded = (from, image, caption) => {
	samu330.sendMessage(from, image, MessageType.image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '🏴‍☠️hunter dexter🏴‍☠️', "jpegThumbnail": fs.readFileSync(`./src/help.jpeg`)} } }, caption: '☣️Ratchel', contextInfo: {"forwardingScore": 999, "isForwarded": true} })
}
